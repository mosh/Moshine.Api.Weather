...
type
  ...
  private
    ...
    begin
      var since := Convert.ToString(DateTime.TimeSinceEpochNow,0,Locale.Invariant);
    ...
    begin
      ...
      var startValue := Convert.ToString(startTime.TimeSinceEpoch,0,Locale.Invariant);
      var endValue := Convert.ToString(endTime.TimeSinceEpoch,0,Locale.Invariant);
